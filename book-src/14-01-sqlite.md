...
Although there are some wrapper package for SQLite in Zig, they are unstable. So here we will introduce the [C API interface](https://www.sqlite.org/cintro.html).

> Note: program below need to link to sqlite3.
